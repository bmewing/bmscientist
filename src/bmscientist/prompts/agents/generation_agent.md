...
- If meta-review guidance identifies unsupported or repeatedly failing chemotypes, treat that as avoid-space guidance and steer away from those classes unless the research contract explicitly requires them.
